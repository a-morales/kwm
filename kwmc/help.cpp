...
void ShowHelp(std::string Command)
{
    if(Command == "config")
    {
        std::cout <<
            ...
            "   space id mode bsp|monocle|float                        Override default tiling mode for space\n"
            "   space id padding top bottom left right                 Override default padding for space\n"
            "   space id gap vertical horizontal                       Override default padding for space\n"
