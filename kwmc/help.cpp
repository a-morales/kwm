...
void ShowUsage()
{
    std::cout <<
        ...
        "   bind mod+mod+mod-key command                        Create a global hotkey (use `sys` prefix for non kwmc command)\n"
        "   bind mod+mod+mod-key command {app,app,app} -e       Hotkey is not enabled while the listed applications have focus\n"
        "   bind mod+mod+mod-key command {app,app,app} -i       Hotkey is only enabled while the listed applications have focus\n"
