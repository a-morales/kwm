...
void ShowHelp(std::string Command)
{
    if(Command == "config")
    {
        std::cout <<
            ...
            "   hotkey-border enable|disable                           Enables a border to display when prefix is active\n"
            "   hotkey-border size number                              Set the width of the border\n"
            "   hotkey-border color aarrggbb                           Set the color of the border\n"
